...
For my story-mapping assignment, I decided to show the number of tweets using #PinkFloyd and filter it by follower count. I chose this hashtag because they're the highest selling artist of all time.
